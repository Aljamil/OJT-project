...
<?php
    ...
    $pdf->Cell(0, 20, "Master List of Active Employees", 0, 1, 'L', true);
    ...
    $sql = "Select * from employee where ActiveStatus='1' and BranchCode='$branchCode'";
    ...
    $pdf->Output('MasterList_Active.pdf', 'I');
